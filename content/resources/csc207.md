...
### What is CSC207?
CSC207 is an introductory course where students will learn popular design patterns, as well as development tools and methods such as version control and the basics of agile methodology. Students will learn how to program in Java using Eclipse IDE.
...
CSC209 is an introductory course to programming in the Linux environment using the language C. This course will teach the student on how to write programs that interact with the operating systems.
